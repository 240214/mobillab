...
class WCPL_Paginate_Navigation_Builder {
	/**
	...
	public function __construct($baseUrl = '/'){
		...
		$baseUrl = str_replace('admin_php', 'admin.php', build_query($uri_arr));
	...
	public function build($limit, $count_all, $currentPage = 1){
		...
		if($currentPage == 1 && $_SERVER['REQUEST_URI'] != $this->getUrl($currentPage)){
			header("HTTP/1.0 301 Moved Permanently");
