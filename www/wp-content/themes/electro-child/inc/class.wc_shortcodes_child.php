...
class WC_Shortcodes_Child{
	...
	public static function init(){
		/*$shortcodes = array(
			'child_product'                    => __CLASS__.'::product',
			'child_product_page'               => __CLASS__.'::product_page',
			'child_product_category'           => __CLASS__.'::product_category',
			'child_product_categories'         => __CLASS__.'::product_categories',
			'child_add_to_cart'                => __CLASS__.'::product_add_to_cart',
			'child_add_to_cart_url'            => __CLASS__.'::product_add_to_cart_url',
			'child_products'                   => __CLASS__.'::products',
			'child_recent_products'            => __CLASS__.'::recent_products',
			'child_sale_products'              => __CLASS__.'::sale_products',
			'child_best_selling_products'      => __CLASS__.'::best_selling_products',
			'child_top_rated_products'         => __CLASS__.'::top_rated_products',
			'child_featured_products'          => __CLASS__.'::featured_products',
			'child_product_attribute'          => __CLASS__.'::product_attribute',
			'child_related_products'           => __CLASS__.'::related_products',
			'child_shop_messages'              => __CLASS__.'::shop_messages',
			'child_woocommerce_order_tracking' => __CLASS__.'::order_tracking',
			'child_woocommerce_cart'           => __CLASS__.'::cart',
			'child_woocommerce_checkout'       => __CLASS__.'::checkout',
			'child_woocommerce_my_account'     => __CLASS__.'::my_account',
		);*/
	...
	public static function product_category($atts){
		...
		$shortcode = new WC_Shortcode_Products_Child($atts, 'product_category');
	...
	public static function recent_products($atts){
		...
		$shortcode = new WC_Shortcode_Products_Child($atts, 'recent_products');

		#\Digidez\Functions::_debug($shortcode);
		return $shortcode->get_content();
	}
	...
	public static function products($atts){
		...
		$shortcode = new WC_Shortcode_Products_Child($atts, $type);
	...
	public static function product($atts){
		...
		$atts['limit'] = '1';
		$shortcode     = new WC_Shortcode_Products_Child((array)$atts, 'product');
	...
	public static function sale_products($atts){
		...
		$shortcode = new WC_Shortcode_Products_Child($atts, 'sale_products');
	...
	public static function best_selling_products($atts){
		...
		$shortcode = new WC_Shortcode_Products_Child($atts, 'best_selling_products');
	...
	public static function top_rated_products($atts){
		...
		$shortcode = new WC_Shortcode_Products_Child($atts, 'top_rated_products');
	...
	public static function featured_products($atts){
		...
		$shortcode = new WC_Shortcode_Products_Child($atts, 'featured_products');
	 ...
	 *
	 * @return     array
	 * @deprecated 3.2.0 Use WC_Shortcode_Products_Child::order_by_rating_post_clauses().
	 */
	public static function order_by_rating_post_clauses($args){
		return WC_Shortcode_Products_Child::order_by_rating_post_clauses($args);
	}
	...
	public static function product_attribute($atts){
		...
		$shortcode = new WC_Shortcode_Products_Child($atts, 'product_attribute');
