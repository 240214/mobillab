...
class Aq_Resize_Custom {
    ...
    /**
     * For your custom default usage you may want to initialize an Aq_Resize_Custom object by yourself and then have own defaults
     */
		...
		try{
			...
			if(!$dims || (((null === $height && $orig_w == $width) xor (null === $width && $orig_h == $height)) xor ($height == $orig_h && $width == $orig_w))){
				...
				elseif(file_exists($destfilename) && getimagesize($destfilename)){
					...
					$img_path = "{$upload_dir}{$dst_rel_path}-{$suffix}.{$ext}";
			...
			error_log('Aq_Resize_Custom.process() error: '.$ex->getMessage());
 ...
 */
function aq_resize_custom($url, $width = null, $height = null, $crop = null, $single = true, $upscale = false){
	/* WPML Fix */
	...
	$aq_resize = Aq_Resize_Custom::getInstance();
